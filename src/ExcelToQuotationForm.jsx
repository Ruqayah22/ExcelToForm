    ...
    <Box sx={{ p: 2 }}>
      ...
      <Box
        ...
        sx={{
          ...
          mb: 3,
          borderRadius: 2,
          background: "linear-gradient(90deg, #fafafa, #fdfdfd)",
      ...
      >
        ...
        {/* Show active file name and sheet */}
        ...
        {sheetNames.length > 1 && (
          <FormControl
            size="small"
            sx={{ minWidth: 220, background: "#fff", borderRadius: "8px" }}
          >
            <InputLabel id="sheet-select-label">Sheet</InputLabel>
            <Select
              labelId="sheet-select-label"
      ...
      >
        ...
        <Button
          ...
          sx={{
            ...
            "&:hover": {
              borderColor: "#047857",
              backgroundColor: "rgba(16,185,129,0.08)", // soft emerald hover
            },
          }}
        >
          📑 PDF
